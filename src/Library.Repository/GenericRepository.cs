...
public class GenericRepository<TEntity> (LibraryDbContext dbContext) : IGenericRepository<TEntity> where TEntity : class
{
    ...
    public IQueryable<TEntity> FromSql ()
    {
        return db.FromSqlRaw("EXEC SP_GetLibraryStat");
    }
